  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 font-chicago text-[16px] text-white cursor-default select-none">
          ⏭
        </div>
        <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 font-chicago text-[16px] text-white cursor-default select-none">
          ⏯
        </div>
        <div className="absolute left-3 top-1/2 transform -translate-y-1/2 font-chicago text-[16px] text-white cursor-default select-none">
          ⏮
        </div>
      </div>
    </div>
