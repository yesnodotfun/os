  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute right-1 text-right top-1/2 transform -translate-y-1/2 font-chicago text-[16px] text-white cursor-default select-none">
          ⏭
        </div>
        ...
        <div className="absolute left-1.5 text-left top-1/2 transform -translate-y-1/2 font-chicago text-[16px] text-white cursor-default select-none">
          ⏮
        </div>
      </div>
    </div>
