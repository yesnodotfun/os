  ...
  helpItems: [
    {
      ...
      description: "Use commands like ls, cd, cat, pwd, and clear to navigate and view files."
    },
    {
      icon: "🧭",
      title: "Navigation",
      description: "The terminal allows you to browse the same file system as Finder."
    },
    {
      icon: "⌨️",
      title: "Command History",
      description: "Press Up and Down arrow keys to cycle through previous commands."
    }
  ],
  metadata: {
    name: "Terminal",
