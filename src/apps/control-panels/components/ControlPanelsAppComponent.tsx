...
export function ControlPanelsAppComponent({
  ...
  const tabListMacOSX = "bg-[#ececec] border-b border-black/20";
  const tabTriggerMacOSX =
    "bg-[#f0f0f0] hover:bg-[#f4f4f4] border border-black/20 data-[state=active]:bg-gradient-to-b data-[state=active]:from-[#ffffff] data-[state=active]:to-[#e8e8e8] data-[state=active]:border-b-[#ececec] data-[state=active]:shadow-sm data-[state=active]:shadow-inner data-[state=active]:relative data-[state=active]:overflow-hidden data-[state=active]:before:absolute data-[state=active]:before:inset-x-1 data-[state=active]:before:top-0.5 data-[state=active]:before:h-[30%] data-[state=active]:before:bg-gradient-to-b data-[state=active]:before:from-white/90 data-[state=active]:before:to-white/30 data-[state=active]:before:rounded-t data-[state=active]:before:pointer-events-none data-[state=active]:after:absolute data-[state=active]:after:inset-x-1 data-[state=active]:after:bottom-1 data-[state=active]:after:h-[20%] data-[state=active]:after:bg-gradient-to-t data-[state=active]:after:from-white/40 data-[state=active]:after:to-transparent data-[state=active]:after:rounded-b data-[state=active]:after:pointer-events-none";
