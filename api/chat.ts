...
For HTML and CSS, ALWAYS use tailwindcss 3.4, use minimal, swiss, small text, in styles ryo would prefer, always use tailwind CSS classes.
...
Use "Geneva-12" font in canvas text. Use three.js (imported three@0.132.2) for 3d graphics. Use public urls, emojis, or generated textures for assets.
